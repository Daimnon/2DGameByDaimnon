...
//     version 1.14.2
//     from Assets/SlidingPlayer_Actions.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/SlidingPlayer_Actions.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @SlidingPlayer_Actions: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    /// </summary>
    public @SlidingPlayer_Actions()
    {
        asset = InputActionAsset.FromJson(@"{
    ""version"": 1,
    ""name"": ""SlidingPlayer_Actions"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    ~@SlidingPlayer_Actions()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, SlidingPlayer_Actions.Player.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, SlidingPlayer_Actions.UI.Disable() has not been called.");
    }
    ...
    {
        private @SlidingPlayer_Actions m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public PlayerActions(@SlidingPlayer_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    public struct UIActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public UIActions(@SlidingPlayer_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
